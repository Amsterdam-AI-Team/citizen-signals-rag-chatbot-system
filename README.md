...
A repository to handle signals (i.e., meldingen) from Amsterdam citizens by providing relevant information using RAG.
...
Feel free to help out! [Open an issue](https://github.com/Amsterdam-AI-Team/citizen-signals-rag-chatbot-system/issues), submit a [PR](https://github.com/Amsterdam-AI-Team/citizen-signals-rag-chatbot-system/pulls) or [contact us](https://amsterdamintelligence.com/contact/).
